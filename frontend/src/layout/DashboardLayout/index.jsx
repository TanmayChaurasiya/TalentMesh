...
export default function DashboardLayout({ children }) {
  ...
  console.log("all_user =", authState?.all_user);
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    setAllProfile(authState.all_user || []);
      ...
      <div className="container">
        <div className={styles.homeContainer}>
          <div className={styles.homeContainer_leftBar}>
            <div className={styles.homeContainer_leftBar_first}>
              <div
                onClick={() => {
            ...
            <div className={styles.homeContainer_leftBar_second}>
              <div
                onClick={() => {
                  router.push("/my_connections");
                }}
                style={{paddingBottom:"1rem" }}
                className={styles.sideBarOption_new}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                ...
                <p style={{ fontSize: "1.15rem"}}>My Connections</p>
                ...
                return (
                  ...
                  >
                    <p
                      ...
                      onClick={() => {
                        router.push(
                          `/view_profile/${profiles.userId.username}`,
                        );
                      }}
                    >
