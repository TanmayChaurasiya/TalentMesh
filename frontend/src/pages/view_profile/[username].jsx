...
export default function ViewProfilePage({ userProfile }) {
  ...
  useEffect(() => {
    ...
    console.log("target user", userProfile.userId._id);

    const targetUserId = userProfile.userId._id;

    /*
      ============================================
      CHECK authState.connections
      ============================================

      Here connectionId can be:
    ...
    */
    ...
    const connection = authState.connections?.find((user) => {
      const connectionId =
        typeof user.connectionId === "object"
          ? user.connectionId?._id
          : user.connectionId;

      const userId =
        typeof user.userId === "object" ? user.userId?._id : user.userId;

      return userId === targetUserId || connectionId === targetUserId;
    });

    /*
      ============================================
      CHECK authState.connectionRequest
      ============================================

      Here connectionId can also be object/string.
    */

    const connectionRequest = authState.connectionRequest?.find((user) => {
      const connectionId =
        typeof user.connectionId === "object"
          ? user.connectionId?._id
          : user.connectionId;
    ...
    /*
      ============================================
      IF CONNECTION/REQUEST EXISTS
      ============================================
    */

    const foundConnection = connection || connectionRequest;
...
export async function getServerSideProps(context) {
  ...
  console.log("Requset", request.data.profile);
